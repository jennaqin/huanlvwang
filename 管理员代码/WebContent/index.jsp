...
<script type="text/javascript">
	$(function(){
		...
		function run(){
			$.ajax({  
				url:"MemberCountAction",//servletæä»¶çåç§°
				type:"get",
				success:function(e,m){
					var obj=JSON.parse(e);
					var obj1=JSON.parse(m);
					$("#ecount").html(obj.ecount);
					$("#ecount1").html(obj.ecount);
					$("#count").html(obj.count);
					$("#name").html(obj1.name);
					$("#email1").html(obj1.email1);
					$("#content").html(obj1.content);
				}
			})
		}
</script>
...
<body>
	<div class="page-container">
			...
			<div class="mother-grid-inner">
				...
				<div class="header-main">
					<div class="header-left">
						<div class="logo-name">
							<a href="index.jsp">
								<h1>Administrator</h1> <!--<img id="logo" src="" alt="Logo"/>-->
							</a>
						</div>
						<!--search-box-->
							...
							<ul class="nofitications-dropdown">
								<li class="dropdown head-dpdn"><a href="#"
									...
									aria-expanded="false"><i class="fa fa-envelope"></i><span
										class="badge" id="ecount">${ecount}</span></a>
									<ul class="dropdown-menu">
										<li>
											<div class="notification_header">
												<h3>You have <span id="ecount1">${ecount}</span> new messages</h3>
											</div>
										</li>
					...
					<div class="market-updates">
						...
						<div class="col-md-4 market-update-gd">
							<div class="market-update-block clr-block-3">
								<div class="col-md-8 market-update-left">
									<h3 id="name">${email.address}</h3>
									<h4 id="content">${email.content}</h4>
									<p id="email1">${email.email1}</p>
								</div>
								<div class="col-md-4 market-update-right">
							...
							<div class="climate-grid1">
								<div class="climate-gd1-top">
									...
									<div class="col-md-6 climate-gd1top-right">
										<span class="clime-icon"> <figure class="icons">
											<canvas id="partly-cloudy-day" width="64" height="64">
											</canvas> </figure> <script>
								...
								<div class="climate-gd1-bottom">
									<div class="col-md-4 cloudy1">
										<h4>Hongkong</h4>
										<figure class="icons"> <canvas id="sleet" width="58"
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					<li id="menu-home"><a href="index.jsp"><i
							class="fa fa-tachometer"></i><span>Home</span></a></li>
					<li><a href="#"><i class="fa fa-cogs"></i><span>Assignment</span><span
							class="fa fa-angle-right" style="float: right"></span></a>
						<ul>
							<li><a href="portlet.jsp">Check</a></li>
						</ul></li>
					<li id="menu-academico"><a href="#"><i
						...
						<ul id="menu-academico-sub">
							...
							<li id="menu-academico-avaliacoes"><a href="signup.jsp">Sign
									Up</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-envelope"></i><span>Mailbox</span><span
						...
						<ul id="menu-academico-sub">
							...
							<li id="menu-academico-boletim"><a href="inbox-details.jsp">Compose
									email</a></li>
						</ul></li>
				</ul>
			</div>
