...
public class IEmailDaoImpl2 implements EmailDao{
	JDBCUtil util;

	public IEmailDaoImpl2() {
		util = new JDBCUtil();
	}
	...
	public List<Email> allEmail(String name,String address,String content,String telephone,String email1) {
		...
		String sql = "insert into email1 (name,address,content,telephone,email1) values(" +"'"+name+"'"+","+"'"+address+"'"+ ","+"'"+content+"'" +","+ "'"+telephone+"'"+","+"'"+ email1+"'" +")";
